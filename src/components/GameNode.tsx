      ...
      <Card className="bg-background border-white/20">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            {node.text.split('\n\n').map((paragraph, i) => (
              <p key={i} className="whitespace-pre-wrap break-words hyphens-auto leading-relaxed">
                {paragraph}
              </p>
            ))}
          </div>
            ...
            <div className="space-y-3">
              {node.choices.map((choice, index) => (
                <Button
                  ...
                  variant="outline"
                  className="w-full text-left h-auto py-4 px-6 justify-start whitespace-pre-wrap break-words hyphens-auto border-white/20 hover:bg-white/10 hover:border-white/40"
                >
